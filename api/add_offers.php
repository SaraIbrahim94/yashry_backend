...
class add_offer extends database{
    ...
    public function add($conn)
    {
        ...
        try {
            ...
            else if($input['name']=='' || $input['discount'] =='' || $input['offer_type'] == '')
            throw new Exception("<span style='color:red'>Error:</span>  <p>please enter input fields as specfied below<strong> Don't leave value empty please.</strong>.<p><ul><li>product name that has the offer as name=t-shirt</li> <li>offer type  with offer_type as key</li><li> discount with discount as a key</li>  <p> ex:</p> <li> offer_type=3 & discount=jacket  </li><li> offer_type=1 & discount=20  </li> <p> type 1->for percentage discount, 2->for amount, 3->for buy 2 get 1 50% off (discount is name of the prodcut to apply 50% off ) </p></ul>");
