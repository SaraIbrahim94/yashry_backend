...
class add_currancy extends database{
    ...
    public function add($conn)
    {
        ...
        try {
            ...
            else if($input['name'] == '' || $input['currancy_type'] == '' || $input['price'] == '')
            throw new Exception("<span style='color:red'>Error:</span><p><strong> Make sure all input values are not empty </strong></p>  please enter input fields as specfied below and make sure you enterd existing product name <ul> <li>product name with name as key</li><li> price with price as a key</li> <li> currancy type with currancy_type as a key</li> <p> ex:</p> <li> name=shoe & price=18 & currancy_type=$ </li> with the same name key</ul>");
